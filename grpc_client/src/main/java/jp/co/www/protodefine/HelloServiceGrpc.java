...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "jp.co.www.protodefine.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<jp.co.www.protodefine.Hello.HelloRequest,
      jp.co.www.protodefine.Hello.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = jp.co.www.protodefine.Hello.HelloRequest.class,
      responseType = jp.co.www.protodefine.Hello.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<jp.co.www.protodefine.Hello.HelloRequest,
      jp.co.www.protodefine.Hello.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<jp.co.www.protodefine.Hello.HelloRequest, jp.co.www.protodefine.Hello.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<jp.co.www.protodefine.Hello.HelloRequest, jp.co.www.protodefine.Hello.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  jp.co.www.protodefine.Hello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  jp.co.www.protodefine.Hello.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(jp.co.www.protodefine.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<jp.co.www.protodefine.Hello.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                jp.co.www.protodefine.Hello.HelloRequest,
                jp.co.www.protodefine.Hello.HelloResponse>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public jp.co.www.protodefine.Hello.HelloResponse sayHello(jp.co.www.protodefine.Hello.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<jp.co.www.protodefine.Hello.HelloResponse> sayHello(
        jp.co.www.protodefine.Hello.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((jp.co.www.protodefine.Hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<jp.co.www.protodefine.Hello.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return jp.co.www.protodefine.Hello.getDescriptor();
    }
